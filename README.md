...
[![GitHub Super-Linter](https://github.com/rahuldimri-org/database-migration-action/actions/workflows/linter.yml/badge.svg)](https://github.com/super-linter/super-linter) ![CI](https://github.com/rahuldimri-org/database-migration-action/actions/workflows/ci.yml/badge.svg) [![Check dist/](https://github.com/rahuldimri-org/database-migration-action/actions/workflows/check-dist.yml/badge.svg)](https://github.com/rahuldimri-org/database-migration-action/actions/workflows/check-dist.yml) [![CodeQL](https://github.com/rahuldimri-org/database-migration-action/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/rahuldimri-org/database-migration-action/actions/workflows/codeql-analysis.yml)[![Coverage](./badges/coverage.svg)](./badges/coverage.svg)
    ...
    jobs:
      schema-migration:
        ...
        steps:
          ...
          - name: Migration
            uses: rahuldimri-org/database-migration-action@v0.0.1
            with:
